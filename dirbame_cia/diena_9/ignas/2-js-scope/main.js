...
// console.log( vardas ); // error nes sis kintamasis neegzistuoja
...
function testLocalVar() {
   var y = "y local";
   z = "z global"; //jei be var sukuriamas kintamasis, jis buna globalus
   console.log("x", x);
   console.log("y", y);
   console.log("z", z);
}
...
function katukai() {
  var katinas = 'baltas';
  console.log('pirmas spausdinimas', katinas);
  console.log('antras spausdinimas consoleje', this.katinas );
}
katukai();
console.log(katinas); //window.katinas
