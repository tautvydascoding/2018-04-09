...
//    var y = "y local";
//    z = "z global"; // be var zodelio yra globalus, nesvarbu ar irasai funkcijoje
//    console.log("x", x);
//    console.log("y", y);
//    console.log("z", z);
// }
...
function katinas_(){
  var katinas = "baltas"; // funkcijos viduje sukurti kintamieji yra naudojami pirmieji.
...
console.log("3 katinas: ", katinas);
 ...
 function test2() {
    ...
    console.log('kayinas f-jos viduje : , window.katinas');
 }
 test2();
 console.log(window);
