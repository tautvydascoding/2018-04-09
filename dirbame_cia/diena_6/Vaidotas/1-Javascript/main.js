...
var x = document.querySelector('h1'); // pasitikrinimas ar selectorius veikia;
console.log(x); // jeigu nieko neisveda- h1 nerado; gali but padaryta tekstine klaida.


 // document.querySelectorAll('h1')[0].innerHTML = " <b>Antraste</b>"; // randa visus
 //
 // document.getElementById('logo'); // iesko su ID, kuris pazymetas hashtagu
 // document.getElementsByClassName('bg-info'); // iesko pagal klase
 // document.getElementsByTagName('h1'); // iesko pagal pavadinima
