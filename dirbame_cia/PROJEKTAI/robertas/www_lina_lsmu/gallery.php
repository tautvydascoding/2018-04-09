...
<body>
  ...
  <!-- TEMP: Bg-video commented out for faster dev load time -->
  ...
  <div class="gallery-content mx-auto">
    <?php foreach (getAllImages() as $img): ?>
      <div id="card-div-<?=$img['id']?>" data-id="<?=$img['id']?>" class="card gallery-card position-relative">
        <img class="gallery-card-cancel-button" src="img/icons/cancel_button.svg" data-toggle="tooltip" data-placement="bottom" data-container="#card-div-<?=$img['id']?>" title="Delete" alt="Card cancel button">

        <img class="gallery-card-edit-button" src="img/icons/edit_button.svg" data-toggle="tooltip" data-placement="bottom" data-container="#card-div-<?=$img['id']?>" title="Edit" alt="Card edit button">
