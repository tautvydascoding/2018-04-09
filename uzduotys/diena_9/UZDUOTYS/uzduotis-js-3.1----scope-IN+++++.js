...
// funkcijos VIDUJE sukurti kintamaji: var vardas = "Tomas"
...
//   UZDUOTIS  B
//  dabar, pabandykite po f-ja (uz jos ribu) i konsole atspausdinti kintamaji "vardas" darkart
//  console.log( vardas) ;
...
//------
 ...
 //    console.log("2 this.katinas - f-jos viduje: ",  this.katinas);    // this - pasiekia ~global kintamuosius (tavo tecio kintamuosius)
     // console.log(   'katinas2 f-jos viduje :',   window.katinas );
 // }
 // test2();
 //
